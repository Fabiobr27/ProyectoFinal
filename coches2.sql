...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-03-2020 a las 21:42:08
...
INSERT INTO `hilo` (`idHilo`, `idUsu`, `titulo`, `texto`, `fecha`, `positivos`, `negativos`) VALUES
(1, 3, 'Esto es una Prueba', 'Probando como va el nuevo foto', '2020-03-25', 0, 0);
...
--
ALTER TABLE `hilo`
  MODIFY `idHilo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `hilo`
  ADD CONSTRAINT `hilo_ibfk_1` FOREIGN KEY (`idUsu`) REFERENCES `usuario` (`idUsu`);
...
--
ALTER TABLE `respuesta`
  ADD CONSTRAINT `respuesta_ibfk_1` FOREIGN KEY (`idHilo`) REFERENCES `hilo` (`idHilo`);
COMMIT;
